...
export default function CompletePage() {
  ...
  const [status, setStatus] = useState<'succeeded' | 'processing' | 'requires_payment_method' | 'default' | 'canceled' | 'requires_action' | 'requires_capture' | 'requires_confirmation'>("default");
