...
const allowedFields: (keyof StripeProduct)[] = ['images', 'name', 'description', 'media', 'details', 'is_featured', 'categories', 'sizes', 'size', 'inventory', 'limit', 'sizeNotes', 'dimensions', 'icons', 'color'];
