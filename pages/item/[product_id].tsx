    ...
    const richResults = [
        {
            ...
            "offers": {
                ...
                "price": props.static.product.selectedPrice?.unit_amount,
                "priceCurrency": "USD",
                            ...
                            >
                                ...
                                {accordion === 'shipping' && (
                                    <div className="column">
                                        ...
                                        {/* <Typography sx={{ fontSize: "0.85rem", whiteSpace: 'pre-wrap' }}>If you are not satisfied with your purchase, we are happy to offer returns and exchanges within 30 days of the delivery date. 
                                        </Typography>
                                        <Typography sx={{ fontSize: "0.85rem", whiteSpace: 'pre-wrap' }}>To be eligible, items must be returned in original condition – unworn, unaltered, unwashed, and with all original tags still attached. 
                                        </Typography>
                                        <Typography sx={{ fontSize: "0.85rem", whiteSpace: 'pre-wrap' }}>To initiate a return/exchange, please contact terandina.info@gmail.com with your order number and reason for return. We will review your request and provide further instructions on how to return/exchange your product. 
                                        </Typography>
                                        <Typography sx={{ fontSize: "0.85rem", whiteSpace: 'pre-wrap' }}>Refunds will be processed within 5-7 business days after we receive the returned item. It may take an additional 2-3 business days for your bank account to reflect the refund.
                                        </Typography>
                                        <Typography sx={{ fontSize: "0.85rem", whiteSpace: 'pre-wrap' }}><strong>Please note:</strong> Original shipping fees are non-refundable. Return shipping costs are the responsibility of the customer.
                                        </Typography> */}
                                    </div>
                                )}
                            </div>
