...
const FAQs = [
    {
        ...
        answer: "Our ponchos, cardigans, hoodies, and blankets are made by indigenous artisans (Quechua) from Ecuador in the Andes Mountain region. We proudly work with small, native-owned workshops, aiming to share their art and creative expression with the world. Our jewelry is handmade from authentic Native American artists from the Southwest. We source jewelry primarily from New Mexico and Arizona."
    },
    {
    ...
    },
    {
        ...
        answer: "Yes, the majority of our jewelry is handcrafted by Native American artisans from Southwestern tribes such as the Navajo, Hopi, and Zuni. We also carry a small selection of pieces that are not stamped, so we cannot guarantee their tribal origin. All of the jewelry is made with sterling silver (.925) and genuine stones. "
    },
    {
